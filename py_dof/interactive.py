...
def print_imoe_gradients_4p(
    mole, one_dm, mf, occs, energies, maxstep=0.0001, verbose=0, moegrads=None
):
    if moegrads == None:
        moegrads = calc_moe_gradients_4p(
...
def print_imoe_gradients_2p(
    mole, one_dm, mf, occs, energies, maxstep=0.00005, verbose=0, moegrads=None
):
    if moegrads == None:
